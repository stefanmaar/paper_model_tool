...
class Pdf:
    ...
    def __init__(self, properties):
        pmt_util.init_exporter(self, properties)
        self.styles = dict()
        ...
        for page in mesh.pages:
            ...
            for island in page.islands:
                ...
                for marker in island.markers:
                    if isinstance(marker, pmt_export.Sticker):
                    ...
                    elif isinstance(marker, pmt_export.Arrow):
                        ...
                        data_markers.append(self.command_arrow.format(
                            ...
                            mat=size * marker.rot,
                            size=size))
                    elif isinstance(marker, pmt_export.NumberAlone):
